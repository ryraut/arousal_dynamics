...
def VAE(xtrain, ytrain, latent_dim=6, beta=.1, num_epochs=100, anneal_step=.0001, lr=.01, pretrained_encoder=[],verbose=True):
    ...
    history = vae.fit(xtrain, ytrain, epochs=num_epochs, batch_size=1000, verbose=verbose)
